...
namespace Datos.Migrations
{
    ...
    [Migration("20240806035849_SchedRegisterTotalInteg")]
    partial class SchedRegisterTotalInteg
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Datos.Entities.SchedulesRegister", b =>
                {
                    ...
                    b.Property<int>("finalHour_id")
                        .HasColumnType("INTEGER");

                    b.Property<int>("initHour_id")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("finalHour_id");

                    b.HasIndex("initHour_id");
            ...
            modelBuilder.Entity("Datos.Entities.Users", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1,
                            creadoEn = new DateTime(2024, 8, 5, 23, 58, 48, 501, DateTimeKind.Local).AddTicks(7381),
                            password = "12345",
                            role_id = 1,
                            username = "admin_test"
                        },
                        ...
                        {
                            id = 2,
                            creadoEn = new DateTime(2024, 8, 5, 23, 58, 48, 501, DateTimeKind.Local).AddTicks(7396),
                            password = "12345",
                            role_id = 2,
                        ...
                        {
                            id = 3,
                            creadoEn = new DateTime(2024, 8, 5, 23, 58, 48, 501, DateTimeKind.Local).AddTicks(7398),
                            password = "12345",
                            role_id = 3,
            ...
            modelBuilder.Entity("Datos.Entities.SchedulesRegister", b =>
                {
                    ...
                    b.HasOne("Datos.Entities.SchedulesSystem", "finalHour")
                        .WithMany()
                        .HasForeignKey("finalHour_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Datos.Entities.SchedulesSystem", "initHour")
                        .WithMany()
                        .HasForeignKey("initHour_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("finalHour");

                    b.Navigation("initHour");
                });
